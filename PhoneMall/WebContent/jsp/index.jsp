...
<html>
	...
	<body>
		<div class="container-fluid" >
            ...
            -->
            <div class="container-fluid">
				<img src="${pageContext.request.contextPath}/products/hao/ad2.png" width="100%"/>
			</div>
			<!--
            	作者：ci2713@163.com
            	时间：2015-12-30
			...
			<div class="container-fluid">
				...
				<div class="col-md-2" style="border:1px solid #E7E7E7;border-right:0;padding:0;">
					<img src="${pageContext.request.contextPath}/products/hao/mid02.png" width="205" height="404" style="display: inline-block;"/>
				</div>
				<div class="col-md-10">
					<div class="col-md-6" style="text-align:center;height:200px;padding:0px;">
						<a href="product_info.htm">
							<img src="${pageContext.request.contextPath}/products/hao/mid002.png" width="516px" height="200px" style="display: inline-block;">
						</a>
					</div>
