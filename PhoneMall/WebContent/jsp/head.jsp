...
<script type="text/javascript">
	...
	$('#search_submit').click(function(){
		...
		//然后跳转到${pageContext.request.contextPath}/product?method=findByPage&pageNumber=1&cid=
		var cid =getparameter('cid');
		location.href="http://localhost/PhoneMall/product?method=findByPage&pageNumber=1&cid="+cid+"&pname="+pname;
		return false
	});
	//将url进行切割，并找到需要的属性值
